...
class Gatling implements Serializable {
  ...
  public static final String GATLING_REPORTS_RELATIVE_PATH   = 'build/gatling/reports'
  public static final String GATLING_REPORTS_DIR             = '$WORKSPACE/' + GATLING_REPORTS_RELATIVE_PATH
